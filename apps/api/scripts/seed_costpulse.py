...
SUPPLIERS: list[tuple[str, list[str], list[str], str, str]] = [
    ("Hòa Phát Group (thép xây dựng)",       ["steel"],                  ["Hanoi", "Ho Chi Minh", "Hai Phong", "Da Nang"], "028-3822-1234", "sales@hoaphat.example.vn"),
    ("Vicem Bút Sơn (xi măng PCB40)",        ["cement"],                 ["Hanoi", "Ha Nam", "Ninh Binh"],                  "024-3550-2345", "kinhdoanh@vicembutson.example.vn"),
    ("Holcim Vietnam (bê tông + xi măng)",   ["concrete", "cement"],     ["Ho Chi Minh", "Dong Nai", "Binh Duong"],          "028-3827-3456", "order@holcim.example.vn"),
    ("Viglacera (gạch ốp lát + gạch xây)",   ["finishing", "masonry"],   ["Hanoi", "Ho Chi Minh", "Bac Ninh"],              "024-3553-4567", "order@viglacera.example.vn"),
    ("Prime Group (gạch ceramic)",           ["finishing"],              ["Vinh Phuc", "Hanoi", "Ho Chi Minh"],             "0211-386-5678", "sales@primegroup.example.vn"),
    ("KOVA Paint (sơn nội/ngoại thất)",      ["finishing"],              ["Ho Chi Minh", "Hanoi", "Da Nang"],               "028-3875-6789", "kinhdoanh@kova.example.vn"),
    ("Sika Vietnam (chống thấm + phụ gia)",  ["finishing"],              ["Ho Chi Minh", "Hanoi"],                          "028-3930-7890", "vietnam.info@sika.example.vn"),
    ("Panasonic Vietnam (thiết bị điện)",    ["mep"],                    ["Ho Chi Minh", "Hanoi", "Binh Duong"],            "028-3910-8901", "b2b@panasonic.example.vn"),
    ("Daikin Vietnam (HVAC thương mại)",     ["mep"],                    ["Ho Chi Minh", "Hanoi"],                          "028-3821-9012", "projects@daikin.example.vn"),
    ("Xuân Trường Minerals (đá + cát)",      ["aggregate"],              ["Ninh Binh", "Hanoi", "Hai Phong"],               "0229-386-0123", "kd@xuantruong.example.vn"),
]
